...
cmake -S "%OPE3rdParty_DIR%/Download/OCCT" -B "%OPE3rdParty_DIR%/Download/OCCT/Build" -D3RDPARTY_DIR=%OCC3RDPARTY_DIR% -DCMAKE_BUILD_TYPE=Debug -DINSTALL_DIR=%OPE3rdParty_DIR%/Install/OCCT -D3RDPARTY_VTK_INCLUDE_DIR=%OCC3RDPARTY_DIR%/VTK-9.5.2/include -DUSE_FREETYPE=TRUE -DUSE_TK=TRUE -DUSE_VTK=TRUE -DINSTALL_FREETYPE=TRUE -DINSTALL_SAMPLES=TRUE -DINSTALL_TK=TRUE -DINSTALL_VTK=TRUE -DUSE_OPENGL=TRUE -DINSTALL_TCL=TRUE -DBUILD_SAMPLES_MFC=TRUE
