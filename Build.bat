...
cmake -S "%OPE3rdParty_DIR%/Download/OCCT" -B "%OPE3rdParty_DIR%/Download/OCCT/Build" -D3RDPARTY_DIR=%OCC3RDPARTY_DIR% -DCMAKE_BUILD_TYPE=Debug -DINSTALL_DIR=%OPE3rdParty_DIR%/Install/OCCT 
